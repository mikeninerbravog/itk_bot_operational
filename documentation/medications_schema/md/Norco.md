### Norco: Constructing JSON Elements for ITK Bot

The JSON structure for Norco includes the following common fields for each indication:

- `indication`: The specific health condition for which Norco is prescribed.
...
```json
{
  ...
  "drugs": {
    "Norco": {
      ...
      "carry_narcan": "Yes",
      "taking_longer_than_6_months": "Yes"
    }
  }
}
```
