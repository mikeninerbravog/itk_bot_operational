### Meloxicam: Constructing JSON Elements for ITK Bot

The JSON structure for Meloxicam includes the following common fields for each indication:

- `indication`: The specific health condition for which Meloxicam is prescribed.
...
```json
{
  ...
  "drugs": {
    "Meloxicam": {
      ...
      "arthritis_restrict_mobility": "Yes"
    }
  }
}
```
