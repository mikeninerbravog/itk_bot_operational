### Lipitor: Constructing JSON Elements for ITK Bot

The JSON structure for Lipitor includes the following common fields for each indication:

- `indication`: The specific health condition for which Lipitor is prescribed.
