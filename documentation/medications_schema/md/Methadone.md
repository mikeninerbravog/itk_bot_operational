### Methadone: Constructing JSON Elements for ITK Bot

The JSON structure for Methadone includes the following common fields for each indication:

- `indication`: The specific health condition for which Methadone is prescribed.
