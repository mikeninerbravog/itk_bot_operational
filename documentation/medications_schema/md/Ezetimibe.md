### Ezetimibe: Constructing JSON Elements for ITK Bot

The JSON structure for Ezetimibe includes the following common fields for each indication:

- `indication`: The specific health condition for which Ezetimibe is prescribed.
