### Celebrex: Constructing JSON Elements for ITK Bot

The JSON structure for Celebrex includes the following common fields for each indication:

- `indication`: The specific health condition for which Celebrex is prescribed.
